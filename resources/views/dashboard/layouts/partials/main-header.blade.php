    ...
    <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
        <a href="/">
            @if (get_setting('appLogo'))
                <img src="{{ get_setting('appLogo') }}" width="110" height="32" alt="{{ get_setting('appName') ?? tenant('name') }}" class="navbar-brand-image">
            @else
                {{ tenant('name') }}
            @endif
    ...
    data-bs-placement="bottom">
            ...
            <div class="card" style="min-width: 250px;">
                ...
                <div class="list-group list-group-flush list-group-hoverable">
                    ...
                    <div class="list-group-item">
                        ...
                        <div class="col text-truncate">
                            <a href="#" class="text-body d-block">{{ __('There are no notifications.') }}</a>
                            <div class="d-block text-muted text-truncate mt-n1">
        ...
        <div class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                ...
                <a href="{{ route('profile.get_setting') }}" class="dropdown-item">
