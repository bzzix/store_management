    ...
    <div class="flex-1 overflow-y-auto overflow-x-hidden no-scrollbar">
        ...
        <nav class="space-y-1.5 px-2">
            ...
            <a href="{{ route('dashboard.payments.index') }}"
                class="flex items-center gap-3 px-3 py-2.5 rounded-xl {{ request()->routeIs('dashboard.payments.*') ? 'bg-primary-50 text-primary-700 font-bold' : 'text-surface-600 hover:bg-surface-100 hover:text-surface-900' }} transition-colors font-medium cursor-pointer group">
                <svg class="w-5 h-5 flex-shrink-0 group-hover:text-primary-600 transition-colors" fill="none"
                    stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
                <span class="nav-text">سندات القبض والصرف</span>
            </a>
